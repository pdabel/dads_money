...
class MoneyService:
    ...
    # Category operations
    def create_category(self, name: str, is_income: bool = False, 
    ...
    def create_transaction(self, account_id: str, date, amount: float,
                          payee: str = "", memo: str = "", check_number: str = "",
                          status = None) -> Transaction:
